/* ================================================================
   ⚠️  이 파일은 더 이상 사용하지 않습니다 (2026.09 통합)
   ────────────────────────────────────────────────────────────────
   갤러리는 News 페이지로 통합되었습니다.
   사진·소식을 추가하려면  →  data/news.js  를 수정하세요.

   이 파일과 gallery/ 폴더는 만약을 대비해 남겨둔 것이며,
   여기를 수정해도 홈페이지에는 반영되지 않습니다.
================================================================ */

/* ================================================================
   GALLERY DATA FILE — SMOP Lab  (구버전 · 보관용)
   ================================================================
